...
export const SEO: Record<string, SeoEntry> = {
  ...
  '/noon-weddings': {
    title: 'חתונות צהריים בצפון | אחוזת סנדרין',
    description:
      'חתונות צהריים וחתונות שישי באחוזת סנדרין — אור יום רך, קונספט יצירתי וצילום מהפנט בגנים לאורך אקוודוקט רומי. תאמו סיור באחוזה.',
    h1: 'חתונות צהריים באחוזת סנדרין',
  },
  '/winter-weddings': {
    title: 'חתונות חורף בצפון | אחוזת סנדרין',
    description:
      'חתונות חורף באחוזת סנדרין — שקיעות מרהיבות, לובי קבלת פנים מפואר וחופות מעוצבות בערב חם ומלכותי. תאמו סיור באחוזה.',
