...
export const SEO: Record<string, SeoEntry> = {
  ...
  '/bar-mitzvah': {
    title: 'בר מצווה בצפון | אחוזת סנדרין',
    description:
      'חוגגים בר מצווה באחוזת סנדרין — גנים פורחים, אולמות עם מסכי LED, עמדות שף כשרות ובית כנסת בלב האחוזה. תאמו סיור.',
    h1: 'בר מצווה באחוזת סנדרין',
  },
  '/bat-mitzvah': {
    title: 'בת מצווה בצפון | אחוזת סנדרין',
    description:
      'בת מצווה חלומית באחוזת סנדרין — עיצוב אישי, רחבת ריקודים סוחפת, קולינריה כשרה וגנים מוארים. בואו לתכנן ערב בלתי נשכח.',
