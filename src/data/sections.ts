...
export const FOOTER = {
  ...
  imagesDisclaimer:
    'התמונות הינן להמחשה בלבד ונכונות למועד צילומן. ייתכן שוני בין המופיע באתר ובין הנראות בפועל לאור שינויים/ שיפוצים/ חידושים/ שידורגים המתבצעים באחוזה מפעם לפעם או על על-פי הצורך.',
} as const
