...
export const GALLERY_CATEGORIES: GalleryCategory[] = [
 ...
 folderCategory('exclusive-events', ' אירועים יוקרתיים ועסקיים', '4/5', 'אירוע יוקרתי באחוזת סנדרין', {
  heroDescription: [
    'המבנה המודולרי, הלובי רחב הידיים ואפשרויות העיצוב הייחודיות מאפשרים לכל זוג, מפיק או חברה להתאים את האחוזה באופן מושלם לחזון האירוע שלהם.',
    'בין אם מדובר באירוע פרטי, אירוע עסקי, כנס, השקה או חגיגה רחבת היקף – אחוזת סנדרין מעניקה את הגמישות, היוקרה והדיוק שהופכים כל רעיון למציאות.',
  ],
}),
  folderCategory('two-halls', 'שתי אחוזות', '4/5', 'שתי האחוזות באולמי סנדרין', {
  heroDescription: [
    'כשאנחנו אומרים שאנחנו יודעים להגשים כל חלום, אנחנו באמת מתכוונים לזה.',
    'האחוזות שלנו תוכננו בצורה מודולרית וחכמה, כך שניתן להתאים אותן לכל סוג אירוע ולכל כמות מוזמנים. קיימת האפשרות לאחד את שתי האחוזות לחגיגה אחת גדולה ומרשימה, ולאפשר לכם להפיק אירועים רחבי היקף מבלי להתפשר על היוקרה, האווירה או חוויית האירוח.',
    'התכנון הייחודי של המתחם מעניק גמישות יוצאת דופן, כך שהוא מתאים באותה מידה לחתונות מרהיבות, אירועים פרטיים יוקרתיים, אירועים עסקיים, השקות, כנסים וחגיגות מכל סוג.',
    'כי כשיש מקום שיודע להתאים את עצמו לחלום שלכם, כל רעיון יכול להפוך למציאות.',
  ],
}),
